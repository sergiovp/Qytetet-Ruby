    ...
    def comprar_titulo_propiedad()
     ...
     def edificar_hotel(casilla)
      ...
      def inicializar_cartas_sorpresa()
        ...
        @mazo << Sorpresa.new("Eres un genio, por eso te conviertes en especulador", 3000, TipoSorpresa::CONVERTIRME);
        @mazo << Sorpresa.new("Te conviertes en especulador por guapo", 5000, TipoSorpresa::CONVERTIRME);
      end
